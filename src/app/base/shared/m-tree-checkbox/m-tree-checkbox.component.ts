...
@Component({
  selector: 'm-tree-checkbox',
  standalone: true,
  imports: [CommonModule, MatTooltipModule],
  templateUrl: './m-tree-checkbox.component.html',
  styleUrl: './m-tree-checkbox.component.scss',
})
export class MTreeCheckboxComponent implements OnInit, OnChanges {
  @Input() data: any[] = [];
